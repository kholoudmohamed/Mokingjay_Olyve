...
class NegativeCases(object):
    ...
    error_zip_code_message_body = (By.ID, 'ngdialog2-aria-describedby')
    error_zip_code_message_header = (By.XPATH, ".//*[contains(@class,'row header')]/div")
    error_zip_code_message_OK = (By.XPATH, ".//*[contains(@class,'row actions')]/div/a")
